...
import input_module_jamfcomputerstest_1624196675_22 as input_module
...
class ModInputjamfcomputers(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("password", title="Password",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("computer_collection_details", title="Computer Collection Details",
                                         description="What to collect, refer to documentation on implications of these selections and logging rates.",
                                         required_on_create=True,
                                         required_on_edit=False))
        ...
        scheme.add_argument(smi.Argument("days_since_contact", title="Days Since Contact",
                                         description="Exclude devices that haven\'t been contacted in the above days. Suggest 7, 14, 30, 90 days. Refer to your own environment",
                                         required_on_create=False,
                                         required_on_edit=False))
